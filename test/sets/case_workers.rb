module Contexts
    module CaseWorkers
        def create_caseworkers
            ...
            last_name: "Keith", email: "mk420@yahoo.com", phone_number: "123-456-7819" )

            @c_admin = FactoryBot.create(:case_worker, user: @admin, first_name: "Trisha", last_name: "Paytas", email: "trishlikefish@yahoo.com", phone_number: "666-666-6666" )
        end
