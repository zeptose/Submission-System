module Logins 
    def login_case_worker
      ...
      @case_worker = FactoryBot.create(:case_worker, user: @case_worker_user, first_name: "john", last_name: "wick", phone_number: "123-123-123", email: "test@gmail.com")
      get login_path
    ...
    def login_parent
      ...
      @parent = FactoryBot.create(:parent, user: @parent_user, p1_first_name: "bob", p1_last_name: "tim",
       p2_first_name: "alex", p2_last_name: "ma", phone_number: "123-123-123", email: "test@gmail.com", 
